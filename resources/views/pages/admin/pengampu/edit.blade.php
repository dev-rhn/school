            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('pengampu.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                @method('PUT')
                                    @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="mahasiswa_id" id="mahasiswa_id" required>
                                                <option value="{{ $item->mahasiswa_id }}" selected hidden>Tidak Diganti</option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="dosen_id" id="dosen_id" required>
                                                <option value="{{ $item->dosen_id }}" selected hidden>Tidak Diganti</option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="matakuliah_id" id="matakuliah_id" required>
                                                <option value="{{ $item->matakuliah_id }}" selected hidden>Tidak Diganti</option>
                                                @foreach ($matkul as $m)
